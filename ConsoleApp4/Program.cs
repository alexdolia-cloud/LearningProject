        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                else if (userInput == "2")
                {
                    ...
                    if (todolist.Tasks.Count - 1 > removeItemIndex && isParsingSucess)
                    {
                ...
                else if (userInput == "4")
                {
                    ...
                    if (todolist.IsNoteExists(markInputIndex))
                    {
                        if (todolist.MarkNotes(markInputIndex))
                        {
